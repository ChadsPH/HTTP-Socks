...
public final class Fagmmmu extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
		...
		this.paintDownloadVpnOn.setColor(Color.WHITE); 
        this.paintUploadVpnOn.setColor(Color.WHITE); 
        this.paintDownloadVpnOff.setColor(Color.WHITE); 
        this.paintUploadVpnOff.setColor(Color.WHITE); 

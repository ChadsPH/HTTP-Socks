...
public class SocksHttpCore
{
    ...
    private void createNotificationChannels() {
        ...
        NotificationChannel mChannel = new NotificationChannel(HttpService.NOTIFICATION_CHANNEL_BG_ID,
        ...
        mChannel = new NotificationChannel(HttpService.NOTIFICATION_CHANNEL_NEWSTATUS_ID,
        ...
        mChannel = new NotificationChannel(HttpService.NOTIFICATION_CHANNEL_USERREQ_ID,

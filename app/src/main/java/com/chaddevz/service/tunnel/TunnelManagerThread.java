package com.chaddevz.service.tunnel;

import android.content.Context;
import java.io.IOException;
import com.chaddevz.service.logger.SkStatus;
import android.content.IntentFilter;
import com.chaddevz.service.tunnel.vpn.TunnelVpnService;
import androidx.localbroadcastmanager.content.LocalBroadcastManager;
import java.util.List;
import com.chaddevz.service.tunnel.vpn.VpnUtils;
import android.util.Log;
import com.chaddevz.service.tunnel.vpn.TunnelState;
import android.content.Intent;
import com.chaddevz.service.tunnel.vpn.TunnelVpnSettings;
import android.content.BroadcastReceiver;
import com.chaddevz.service.HttpService;
import com.chaddevz.service.tunnel.vpn.TunnelVpnManager;
...
import com.chaddevz.service.config.PasswordCache;
		...
		ServerHostKeyVerifier, DebugLogger
{
		...
		while (!mStopping) {
			try {
				if (!TunnelUtils.isNetworkOnline(mContext)) {
					...
					if (tries > 0)
						MainActivity.mAdapter.clearLog();
	...
	*/
	...
	protected void startTunnelVpnService() throws IOException {
		...
		String dns1 = mConfig.getPrivString("primary_dns");
		String dns2 = mConfig.getPrivString("secondary_dns");
		if (m_dnsForward) {

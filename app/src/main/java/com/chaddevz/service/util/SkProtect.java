package com.chaddevz.service.util;
...
public class SkProtect {
	...
	private static final String APP_BASE = "com.chaddevz.sockshttp";
	...
	public void simpleProtect() {
		if (!APP_BASE.equals(mContext.getPackageName().toLowerCase()) ||
				!mContext.getString(R.string.app_name).toLowerCase().equals("http socks")) {
			throw new RuntimeException();
		}
	}
